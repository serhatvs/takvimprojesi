...
Bir sonraki urun dikey ozelligi olarak CHANGES_REQUESTED etkinlikleri kulüp dashboard’unda düzenleme ve yeniden onaya gönderme gelistirilmeli.
...
- Unit tests: gecti; API 122 test, contracts 2 test, web 125 test. Config/ui test dosyasi olmadigi icin acik `--passWithNoTests`.
- Integration tests: gecti; API 130 integration test. Diger paketlerde integration dosyasi olmadigi icin acik `--passWithNoTests`.
