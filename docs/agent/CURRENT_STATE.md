...
- QR gorseli, kamera tarayici, dashboard ve manuel check-in henuz uygulanmadi.
...
- Unit tests: gecti; API 92 test, contracts 2 test, web 28 test. Config/ui test dosyasi olmadigi icin acik `--passWithNoTests`.
