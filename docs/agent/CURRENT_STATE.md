...
Kulüp yöneticileri için yayınlanmış etkinliklerin iptal edilmesi veya tamamlanması akışları veya Basın Yayın editörleri için etkinlik arama ve detaylı filtreleme arayüzleri geliştirilebilir.
...
- Unit tests: gecti; API 135 test, contracts 2 test, web 136 test.
